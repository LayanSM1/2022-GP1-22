...
class AuthenticationScreen extends GetWidget<AuthenticationController> {
  ...
  AuthenticationScreen({ required String this.Email,required String this.Password});
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      padding: getPadding(
                                          left: 101, top: 22, right: 101),
                                      child: Text("OTP Verification".tr,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                          style: AppStyle
                                              .txtRubikRomanSemiBold32
                              ...
                              Align(
                                  ...
                                  child: Container(
                                      ...
                                      margin: getMargin(
                                          left: 72, top: 21, right: 72),
                                      child: Text("Enter the OTP we just sent on your phone number".tr,
                                          maxLines: 3,
                                  ...
                                  child: FutureBuilder<QuerySnapshot>(
                                      ...
                                      builder: (context,snapshot){
                                        ...
                                        if(snapshot.connectionState == ConnectionState.done)
                                        {
                                          ...
                                          print(phonenumber);
                                          verifyPhone(phonenumber!);
                                          return Center(child: Text(documents[0]['PhoneNumber'],style: TextStyle(color: Colors.white),));
                                        }
                                        return Center(child: CircularProgressIndicator());
                                      }),
                                ),
                              ...
                              CustomButton(
                                  ...
                                  text: "Verify OTP".tr,
                                  margin:
                                  getMargin(left: 24, top: 41, right: 24),
                                  shape: ButtonShape.CircleBorder29,
                                  padding: ButtonPadding.PaddingAll20,
                                  fontStyle: ButtonFontStyle.RubikRegular1675,
...
try{
  ...
  Utils.toastMessage("The OTP you entered is wrong !! ");
