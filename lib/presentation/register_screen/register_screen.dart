...
class RegisterScreen extends StatefulWidget {
  String name;
  RegisterScreen({required this.name});
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  TextEditingController frameConfirmPasswordController =
  ...
  TextEditingController phonNumberContorller = TextEditingController();
  @override
  void dispose() {
    frameNameController.dispose();
    frameEmailController.dispose();
    framePasswordController.dispose();
    frameConfirmPasswordController.dispose();
    framePhoneController.dispose();
    super.dispose();
  }
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      CustomTextFormField(
                                          width: 319,
                                          focusNode: FocusNode(),
                                          controller: frameEmailController,
                                      ...
                                      //     width: 319,
                                      //     focusNode: FocusNode(),
                                      //     controller: framePhoneController,
                                      ...
                                      CustomButton(
                                          onTap: () async {
                                            if (_formKey.currentState!
                                              ...
                                              phoneNumber =
                                                  '$countryCode${phonNumberContorller.text}';
                                              print("+++++++++++++++");
                                              print(phoneNumber);
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    validator: (val) {
                      ...
                      if (val.length < 7)
                        return "Phone Number cann\'t be smaller then 7 digits";
                      if (val.length > 11)
                        return "Phone Number cann\'t be greater then 11 digits";
                      return null;
                    },
                    // onEditingComplete: () {
