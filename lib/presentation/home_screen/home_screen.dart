    ...
    return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Container(
                width: 40,
                child: CommonImageView(imagePath: ImageConstant.imgTipplerlogore61X54)
            ),
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          child: Stack(alignment: Alignment.topRight, children: [
                                                                            ...
                                                                            Align(
                                                                                ...
                                                                                child: Padding(padding: getPadding(left: 10, bottom: 10), child: Text("Kholoud", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtQuicksandBold48)))
                                                                          ])))
                                                                ])))
                                                  ]))),
                                      Container(
